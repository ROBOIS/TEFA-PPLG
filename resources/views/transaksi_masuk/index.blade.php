...
<div class="d-flex" style="position:relative;">
    ...
    <main class="flex-fill p-4">
        ...
        <a href="{{ route('transaksi-masuk.create') }}" class="btn btn-primary mb-3">Tambah Transaksi Masuk</a>
        @if(session('success'))
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $t->tanggal }}</td>
                    <td>
                        <form action="{{ route('transaksi-masuk.destroy', $t->id) }}" method="POST" onsubmit="return confirm('Yakin hapus?')">
                            @csrf
                            @method('DELETE')
