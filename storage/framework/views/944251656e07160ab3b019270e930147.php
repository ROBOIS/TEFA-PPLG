...
<div class="d-flex" style="position:relative;">
    ...
    <main class="flex-fill p-4">
        ...
        <a href="<?php echo e(route('transaksi-masuk.create')); ?>" class="btn btn-primary mb-3">Tambah Transaksi Masuk</a>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Rp<?php echo e(number_format($t->harga_beli,0,',','.')); ?></td>
                    <td><?php echo e($t->tanggal); ?></td>
                    <td>
                        <form action="<?php echo e(route('transaksi-masuk.destroy', $t->id)); ?>" method="POST" onsubmit="return confirm('Yakin hapus?')">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\KeuanganTefa\AplikasiTefa\resources\views/transaksi_masuk/index.blade.php ENDPATH**/ ?>