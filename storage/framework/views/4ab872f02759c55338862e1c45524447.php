            ...
            <div class="col-md-3 mb-2">
                <div class="card text-bg-light h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text fs-4"><?php echo e($totalBarang ?? '-'); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-2">
                <div class="card text-bg-light h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text fs-4"><?php echo e($totalMasuk ?? '-'); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-2">
                <div class="card text-bg-light h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text fs-4"><?php echo e($totalKeluar ?? '-'); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-2">
                <div class="card text-bg-light h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text fs-4">Rp<?php echo e(number_format($totalNilaiKeluar ?? 0,0,',','.')); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\KeuanganTefa\AplikasiTefa\resources\views/dashboard.blade.php ENDPATH**/ ?>